 ...
 */
final class Version20250304142739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse DROP type_reclamation_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse ADD type_reclamation_id INT DEFAULT NULL');
